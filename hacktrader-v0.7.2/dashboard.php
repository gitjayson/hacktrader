    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 720px) {
            ...
            .focus-node { width: 148px; min-height: 148px; }
            .indicator-node { width: 96px; min-height: 88px; }
        }
    </style>
</head>
<body onload='syncToleranceValue(); updateDashboard()'>
    ...
    <main class='app-shell'>
        ...
        <footer>HackTrader · visual refresh · v0.7.2</footer>
    </main>
    ...
    <script>
        ...
        async function updateDashboard(newTicker = null, options = {}) {
            ...
            try {
                ...
                const indicatorHalf = window.innerWidth <= 720 ? 44 : 52;
                const usableRadius = (clockRect.width / 2) - indicatorHalf - 12;
                const radius = Math.max(92, Math.min(usableRadius, 205));

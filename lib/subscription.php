...
// v0.13.4 — hacktrader_app_url() lives in its own file now so callers
// that only need URL building (e.g. callback.php for OAuth redirect URI)
// don't have to pull in the DB/plans layer too.
...
if (!defined('HACKTRADER_SUBSCRIPTION_LOADED')) {
    ...
    // v0.13.4 — hacktrader_app_url() relocated to lib/app_url.php so
    // callback.php (and any other URL-building caller) can include it
    // without dragging in the DB/plans dependencies. The require_once
    // at the top of this file means existing call sites in this module
    // still see the function as before.
}

...
<head>
    ...
    <title>HackTrader | v0.13.3</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .controls {
            ...
            display: grid;
            /* v0.13.2 — Lite toggle moved out of the topbar to the radar
        ...
        /* v0.13.2 — copyright now held by Penguins LLC. Footer brand links
        ...
        @media (max-width: 1260px) {
            ...
            /* v0.13.2 — keep 5 cols at this breakpoint. The 4-col attempt
        ...
        /* v0.13.2 — persistent "not a forecast" tagline in the focus
        ...
        /* v0.13.2 — small-label contrast bump. Co-Claude flagged the
        ...
        /* v0.13.2 — Lite mode toggle relocated to bottom-right of the radar
...
<body class='<?= $liteMode ? "lite" : "" ?>' onload='syncToleranceValue(); applyLiteFromStorage(); updateDashboard()'>
    ...
    <main class='app-shell'>
        <header class='topbar glass'>
            ...
            <div class='controls'>
                ...
                <!-- Lite toggle moved to the radar card bottom-right corner in
                     v0.13.2 for spatial-proximity discoverability. -->
            ...
            <section class='main-column' aria-label='HackTrader cockpit'>
                ...
                <section class='hero-row'>
                    <div class='focus-header'>
                        ...
                        <!-- v0.13.2 — persistent honesty stance. Counters the
                ...
                <section class='radar-card glass'>
                    ...
                    <!-- v0.13.2 — Lite toggle in the corner of the radar card.
        ...
        <footer>
            HackTrader v0.13.3 · © 2026 <a href='https://pngs.us' target='_blank' rel='noopener' class='footer-brand'>PENGUINS LLC</a> · All rights reserved.<br>
    ...
    <script>
        ...
        function updateStatusChip(data) {
            ...
            // v0.13.2 — Massive provides 15-minute-delayed market data,
        ...
        function setFocusNode(symbol, data, tolerance, verdict) {
            ...
            const probs = data?.probabilities || {};
            const bias = probs.bias || 'neutral';
            // v0.13.2 — same colorblind-safe glyph set as indicator nodes.
        ...
        async function updateDashboard(newTicker = null, options = {}) {
            ...
            // v0.13.2 — default ticker priority: explicit arg > input value >
            ...
            try {
                ...
                const promises = sortedIndicators.map(async (indObj, i) => {
                    ...
                    try {
                        ...
                        // v0.13.2 — colorblind-safe direction glyph. Triangles

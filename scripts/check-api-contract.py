...
assert (
    ...
    in dash
), "dashboard period selector mismatch"
assert (
    'exec python3 "$SCRIPT_DIR/run-brk.py"' in wrapper
), "wrapper is not using python production runner"
...
print(
    "Contract checks passed: dashboard periods, api normalization, and wrapper argv contract are aligned."
)
